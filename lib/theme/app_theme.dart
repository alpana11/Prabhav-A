...
class AppTheme {
  ...
  // Professional Trust Palette - Civic engagement color system
  static const Color primaryLight = Color(0xFF003366); // Deep civic blue
  static const Color primaryVariantLight = Color(0xFF002244);
  static const Color secondaryLight = Color(0xFFF5F7FA); // Soft background gray
  static const Color accentLight = Color(0xFF009688); // Teal accent
  static const Color successLight = Color(0xFF4CAF50); // Clear green
  ...
  static const Color borderLight = Color(0xFFE0E0E0); // Subtle gray
  ...
  // Dark theme colors - maintaining civic professionalism
  ...
  static const Color accentDark = Color(0xFF009688); // Teal accent
  ...
  /// Light theme - Contemporary Civic Minimalism
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme - professional civic authority
    ...
    // Card theme - minimal elevation for content hierarchy
    ...
    // Bottom navigation - civic-appropriate styling
    ...
    // FAB theme - strategic placement for complaint registration
    ...
    // Button themes - consistent civic styling
    ...
    // Typography - Inter font family for civic readability
    textTheme: _buildTextTheme(isLight: true),

    // Input decoration - clean, accessible form styling
    ...
    // Interactive elements - civic-appropriate feedback
    ...
    // Progress indicators - civic status visualization
    ...
    //     borderSide: BorderSide(width: 2.0, color: primaryLight),
  ...
  /// Dark theme - maintaining civic professionalism in dark mode
